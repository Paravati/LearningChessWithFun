...
#                                           generateFieldNames(n, swapSide), swapSide)
...
#                     print(pos_of_click)
#                     field_name = getNameOfField(board_field_names, pos_of_click, x_offset_of_Board, y_offset_of_Board,
#                                                 sq_sz)
...
def chessboardSquareNotation(n, sq_len, x_offset_of_Board, y_offset_of_Board, listWithFieldNames, swap=False):
    ...
    for row in range(n):  # Draw each row of the board.
        for col in range(n):  # Run through cols drawing squares
            ...
            dictTmp = {listWithFieldNames[col][row]: the_square}
...
if __name__ == "__main__":
    draw_board([1, 2, 3, 4, 5, 6, 7, 8], True, False)
